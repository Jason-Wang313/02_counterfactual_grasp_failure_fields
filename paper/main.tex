...
\begin{table}[t]
    ...
    \label{tab:bias}
    \resizebox{\linewidth}{!}{\input{tables/bias_worst_group_table.tex}}
\end{table}
...
\begin{table}[t]
    ...
    \label{tab:mask}
    \resizebox{0.82\linewidth}{!}{\input{tables/mask_feasibility_table.tex}}
\end{table}
...
\begin{table}[t]
    ...
    \label{tab:noise}
    \resizebox{\linewidth}{!}{\input{tables/noise_boundary_table.tex}}
\end{table}
